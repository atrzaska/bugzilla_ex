defmodule Bugzilla.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Bugzilla.Repo)
  ...
  """
  def valid_password?(%Bugzilla.Accounts.User{hashed_password: hashed_password}, password)
