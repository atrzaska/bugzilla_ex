defmodule BugzillaWeb.UserAuthTest do
  use BugzillaWeb.ConnCase, async: true

  alias Bugzilla.Accounts
  alias BugzillaWeb.UserAuth
  import Bugzilla.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, BugzillaWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      BugzillaWeb.Endpoint.subscribe(live_socket_id)
